...
import static org.mule.tools.api.ContentGenerator.createArtifactClassLoaderModelJsonFile;
import static org.mule.tools.api.ContentGenerator.createPluginClassLoaderModelJsonFile;
...
public abstract class DeployableFileBuilder<T extends DeployableFileBuilder<T>> extends AbstractArtifactFileBuilder<T> {
  ...
  private File createClassLoaderModelJsonFile(AbstractDependencyFileBuilder dependencyFileBuilder) {
    ...
    return createPluginClassLoaderModelJsonFile(classLoaderModel, repository);
  }
  ...
  private File getClassLoaderModelFile() {
    ...
    return createArtifactClassLoaderModelJsonFile(classLoaderModel, Paths.get(getTempFolder()));
  }
